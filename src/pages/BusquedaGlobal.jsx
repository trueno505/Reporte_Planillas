...
export default function BusquedaGlobal() {
  ...
  const buscar = async (e) => {
    ...
    const { data, error } = await supabase.rpc('buscar_trabajador', { termino: termino.trim() })
    setLoading(false)
    ...
    <Layout>
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-500 text-sm mb-6">
          Busca un trabajador por DNI o parte de su nombre. Se consultan las 19 planillas simultáneamente.
        </p>
        ...
        <form onSubmit={buscar} className="flex gap-2 mb-6">
          <input
            ...
            className="flex-1 border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
            autoFocus
          />
          <button
            type="submit"
