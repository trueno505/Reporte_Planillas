...
`01_extensions` → `02_perfiles` → `03_tablas` → `04_rls` → `05_realtime` → `06_auditoria` → `07_funciones` → `08_admin` → `09_totales` → `10_indices` → `11_operaciones` → `12_fix_auditoria_y_admin`
